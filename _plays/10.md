...
At every stage of a project, we should measure how well our solution is working for our users. This includes measuring how well a solution performs and how people are interacting with it in real-time. Our teams and leadership should carefully watch these metrics to find issues and identify which bug fixes and improvements should be prioritized. Along with monitoring tools, a feedback mechanism should be in place for people to report issues directly.
...
### Key Questions
- What are the key metrics for the solution?
- How have these metrics performed over the life of the solution?
- Which system monitoring tools are in place?
- What is the targeted average response time for your solution? What percent of requests take more than 1 second, 2 seconds, 4 seconds, and 8 seconds?
...
- What is the volume of each of your solution’s top 10 transactions? What is the percentage of transactions started vs. completed?
- What is your solution’s monthly uptime target?
- What is your solution’s monthly uptime percentage, including scheduled maintenance? Excluding scheduled maintenance?
