...
We should use an incremental, fast-paced style of software development to reduce the risk of failure. We want to get working software into users’ hands as early as possible to give the design and development team opportunities to adjust based on user feedback about the product. A critical capability is being able to automatically test and deploy the productr so that new features can be added often and be put into production easily.
...
3. Ensure the individuals building the service communicate closely using techniques such as launch meetings, daily standups, and team chat tools
